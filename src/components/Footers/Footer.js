...
export default function Footer() {
  return (
    <>
      <footer className="block bg-blueGray-200 pt-8 pb-6">
        <div
        ...
        <div className="container bottom-0 top-0 left-0 right-0 w-full absolute pointer-events-none overflow-hidden -mt-20 h-20 mx-auto px-4">
