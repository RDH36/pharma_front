...
import TestDepart from "components/PartiesTable/TestDepart.js";
      ...
      <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded max-height-500pix overflow-y-auto">
        ...
        <div className="block w-full overflow-x-auto">
          ...
          <table className="items-center w-full bg-transparent border-collapse">
            <thead>
              <tr>
                <TableHeader>Titre colonne 1</TableHeader>
                <TableHeader>Titre colonne 2</TableHeader>
                <TableHeader>Titre colonne 3</TableHeader>
                <TableHeader>Titre colonne 4</TableHeader>
              </tr>
            </thead>
            <tbody>
              <tr>
