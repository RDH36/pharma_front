...
import RowPharmacieDeGarde from "components/PartiesTable/RowPharmacieDeGarde";


// components
import TableHeader from "components/PartiesTable/TableHeader.js";

export default class TableauListePharmaOuvert extends Component {
  render() {
    return (
      <>
