...
import DashboardDropdown from "components/Dropdowns/DashboardDropdown.js";
        ...
        <div className="container px-4 mx-auto flex flex-wrap items-center justify-between">
          ...
          >
            ...
            <ul className="flex flex-col lg:flex-row list-none lg:ml-auto">
              ...
              <li className="flex items-center">
                <div className="text-6xl fa-2x lg:text-white lg:hover:text-blueGray-200 text-blueGray-700 px-3 py-4 lg:py-2 flex items-center text-xs font-bold">
                  <h1 className="text-6xl fa-2x">
              ...
              <li className="flex items-center">
                ...
                >
                  ...
                  <span className="inline-block ml-2">Aide ?</span>
                </a>
              </li>
              <li className="flex items-center">
                <button
                  ...
                  type="button"
                >
                  <i className="fas fa-clinic-medical"></i> Mon compte
                </button>
              </li>
            </ul>
          </div>
