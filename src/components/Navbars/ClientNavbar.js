...
<span style={{margin:'0px 5px 0px 5px'}}>Pharmacie {donnePharma.nomPharmacie}</span>
              ...
              <li className="flex items-center">
                ...
                <button
                  ...
                  type="button"
                >
                  <i className="fas fa-shopping-cart fa-2x"></i>  <span style={{fontWeight: 'bold'} } className=" text-white p-3 text-center inline-flex items-center justify-center w-4 h-4  shadow-lg rounded-full bg-red-500">{countPanier.count}</span>
                </button>
                </Link>
              </li>
